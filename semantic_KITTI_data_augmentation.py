...
class SemanticKitti(torch.utils.data.Dataset):
    def __init__(self, dataset_dir: Path, split: str, augmentation: bool, obscure_factor: float) -> None:
        self.split = split
        self.seqs = splits[split]
        self.dataset_dir = dataset_dir
        self.sweeps = []
        self.augmentation = augmentation
        self.obscure_factor = obscure_factor
    ...
    def __getitem__(self, index):
        ...
        #### obscuring rangeview with noise
        if self.augmentation:
            ...
            num_zeros = int(num_pixels * self.obscure_factor)
            ...
            # Set the corresponding pixels in the image to 0
